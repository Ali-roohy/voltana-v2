...
| TASK-0042 | developer | **READY** (2026-06-23, pm) — Analytics Bugs + Smart Session Features. Section A bugs (BUG-1 Jalali axes, BUG-2 expanded list, BUG-3 odometer order, BUG-4 cumulative-odometer enforcement + distance/efficiency, BUG-5 unclamp SOH) then Section B (migration 000020 + FEAT-1..6 smart session). Chain starts on BUG-1. See `.ai/workflows/TASK-0042.md`. |
